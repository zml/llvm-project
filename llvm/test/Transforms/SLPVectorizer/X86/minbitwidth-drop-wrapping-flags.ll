...
; CHECK-NEXT:    [[DEC_7:%.*]] = or i8 [[A_PROMOTED]], 0
; CHECK-NEXT:    [[CONV_I_7:%.*]] = zext i8 [[DEC_7]] to i32
; CHECK-NEXT:    [[SUB_I_7:%.*]] = add nuw nsw i32 [[CONV_I_7]], 0
; CHECK-NEXT:    [[TMP2:%.*]] = or i32 [[TMP1]], [[SUB_I_7]]
; CHECK-NEXT:    [[TMP3:%.*]] = and i32 [[TMP2]], 65535
; CHECK-NEXT:    store i8 [[DEC_7]], ptr null, align 1
; CHECK-NEXT:    [[CALL3:%.*]] = tail call i32 (ptr, ...) null(ptr null, i32 [[TMP3]])
