...
; CHECK-NEXT:    [[TMP1:%.*]] = call i1 @llvm.vector.reduce.add.v4i1(<4 x i1> [[X:%.*]])
...
; CHECK-NEXT:    [[TMP1:%.*]] = call i1 @llvm.vector.reduce.add.v8i1(<8 x i1> [[X:%.*]])
...
; CHECK-NEXT:    [[TMP1:%.*]] = call i1 @llvm.vector.reduce.add.v16i1(<16 x i1> [[X:%.*]])
...
; CHECK-NEXT:    [[TMP1:%.*]] = call i1 @llvm.vector.reduce.add.v128i1(<128 x i1> [[X:%.*]])
