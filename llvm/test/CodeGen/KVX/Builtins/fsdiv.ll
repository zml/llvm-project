...
define float @fsdivw(float %0, float %1) {
; ALL-LABEL: fsdivw:
; ALL:       # %bb.0:
; ALL-NEXT:    fsdivw $r0 = $r0r1
; ALL-NEXT:    ret
; ALL-NEXT:    ;; # (end cycle 0)
  %3 = tail call float @llvm.kvx.fsdiv.f32(float %0, float %1, i32 0)
  ret float %3
}

declare float @llvm.kvx.fsdiv.f32(float, float, i32)
...
; ALL-NEXT:    ;; # (end cycle 4)
  ...
  %8 = tail call <2 x float> @llvm.kvx.fsdiv.v2f32(<2 x float> %6, <2 x float> %7, i32 0)
  ...
  %11 = tail call <2 x float> @llvm.kvx.fsdiv.v2f32(<2 x float> %9, <2 x float> %10, i32 0)
  ...
  %14 = tail call <2 x float> @llvm.kvx.fsdiv.v2f32(<2 x float> %12, <2 x float> %13, i32 0)
...
declare <2 x float> @llvm.kvx.fsdiv.v2f32(<2 x float>, <2 x float>, i32)

define <2 x float> @fsdivwp(<2 x float> %0, <2 x float> %1) {
; ALL-LABEL: fsdivwp:
; ALL:       # %bb.0:
; ALL-NEXT:    fsdivwp $r0 = $r0r1
; ALL-NEXT:    ret
; ALL-NEXT:    ;; # (end cycle 0)
  %3 = tail call <2 x float> @llvm.kvx.fsdiv.v2f32(<2 x float> %0, <2 x float> %1, i32 0)
  ret <2 x float> %3
}
...
define double @fsdivd(double %0, double %1) {
; ALL-LABEL: fsdivd:
; ALL:       # %bb.0:
; ALL-NEXT:    fsdivd $r0 = $r0r1
; ALL-NEXT:    ret
; ALL-NEXT:    ;; # (end cycle 0)
  %3 = tail call double @llvm.kvx.fsdiv.f64(double %0, double %1, i32 0)
  ret double %3
}

declare double @llvm.kvx.fsdiv.f64(double, double, i32)
...
; ALL-NEXT:    ;; # (end cycle 2)
  ...
  %8 = tail call double @llvm.kvx.fsdiv.f64(double %6, double %7, i32 0)
...
; ALL-NEXT:    ;; # (end cycle 4)
  ...
  %11 = tail call double @llvm.kvx.fsdiv.f64(double %9, double %10, i32 0)
  %12 = extractelement <4 x double> %0, i64 3
  %13 = extractelement <4 x double> %1, i64 3
  %14 = tail call double @llvm.kvx.fsdiv.f64(double %12, double %13, i32 0)
