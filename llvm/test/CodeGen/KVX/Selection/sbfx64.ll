...
; V2-LABEL: f3imm:
; V2:       # %bb.0: # %entry
; V2-NEXT:    sbfx64w $r0 = $r0, 0xffffa460
; V2-NEXT:    ret
; V2-NEXT:    ;; # (end cycle 0)
entry:
  %shl = shl i32 %b, 6
...
; V2-LABEL: f5imm:
; V2:       # %bb.0: # %entry
; V2-NEXT:    sbfx64uwd $r0 = $r0, 0x1e240
; V2-NEXT:    ret
; V2-NEXT:    ;; # (end cycle 0)
entry:
  %shl = shl nuw i32 %b, 6
...
; V2-LABEL: f7imm:
; V2:       # %bb.0: # %entry
; V2-NEXT:    sbfx64wd $r0 = $r0, 0xffffa460
; V2-NEXT:    ret
; V2-NEXT:    ;; # (end cycle 0)
entry:
  %shl = shl nsw i32 %b, 6
