...
; CV1-NEXT:  Cost Model: Invalid cost for instruction: %V2i1 = call i1 @llvm.vector.reduce.umax.v2i1(<2 x i1> undef)
; CV1-NEXT:  Cost Model: Invalid cost for instruction: %V3i1 = call i1 @llvm.vector.reduce.umax.v3i1(<3 x i1> undef)
; CV1-NEXT:  Cost Model: Invalid cost for instruction: %V4i1 = call i1 @llvm.vector.reduce.umax.v4i1(<4 x i1> undef)
; CV1-NEXT:  Cost Model: Invalid cost for instruction: %V8i1 = call i1 @llvm.vector.reduce.umax.v8i1(<8 x i1> undef)
; CV1-NEXT:  Cost Model: Invalid cost for instruction: %V16i1 = call i1 @llvm.vector.reduce.umax.v16i1(<16 x i1> undef)
; CV1-NEXT:  Cost Model: Invalid cost for instruction: %V32i1 = call i1 @llvm.vector.reduce.umax.v32i1(<32 x i1> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %V2i8 = call i8 @llvm.vector.reduce.umax.v2i8(<2 x i8> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %V3i8 = call i8 @llvm.vector.reduce.umax.v3i8(<3 x i8> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %V4i8 = call i8 @llvm.vector.reduce.umax.v4i8(<4 x i8> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 11 for instruction: %V8i8 = call i8 @llvm.vector.reduce.umax.v8i8(<8 x i8> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 21 for instruction: %V16i8 = call i8 @llvm.vector.reduce.umax.v16i8(<16 x i8> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 39 for instruction: %V32i8 = call i8 @llvm.vector.reduce.umax.v32i8(<32 x i8> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 73 for instruction: %V64i8 = call i8 @llvm.vector.reduce.umax.v64i8(<64 x i8> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %V2i16 = call i16 @llvm.vector.reduce.umax.v2i16(<2 x i16> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %V4i16 = call i16 @llvm.vector.reduce.umax.v4i16(<4 x i16> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %V8i16 = call i16 @llvm.vector.reduce.umax.v8i16(<8 x i16> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 22 for instruction: %V16i16 = call i16 @llvm.vector.reduce.umax.v16i16(<16 x i16> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %V2i32 = call i32 @llvm.vector.reduce.umax.v2i32(<2 x i32> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %V4i32 = call i32 @llvm.vector.reduce.umax.v4i32(<4 x i32> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 13 for instruction: %V8i32 = call i32 @llvm.vector.reduce.umax.v8i32(<8 x i32> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %V2i64 = call i64 @llvm.vector.reduce.umax.v2i64(<2 x i64> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %V4i64 = call i64 @llvm.vector.reduce.umax.v4i64(<4 x i64> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret void
;
; CV2-LABEL: 'reduce_umax'
; CV2-NEXT:  Cost Model: Invalid cost for instruction: %V2i1 = call i1 @llvm.vector.reduce.umax.v2i1(<2 x i1> undef)
; CV2-NEXT:  Cost Model: Invalid cost for instruction: %V3i1 = call i1 @llvm.vector.reduce.umax.v3i1(<3 x i1> undef)
; CV2-NEXT:  Cost Model: Invalid cost for instruction: %V4i1 = call i1 @llvm.vector.reduce.umax.v4i1(<4 x i1> undef)
; CV2-NEXT:  Cost Model: Invalid cost for instruction: %V8i1 = call i1 @llvm.vector.reduce.umax.v8i1(<8 x i1> undef)
; CV2-NEXT:  Cost Model: Invalid cost for instruction: %V16i1 = call i1 @llvm.vector.reduce.umax.v16i1(<16 x i1> undef)
; CV2-NEXT:  Cost Model: Invalid cost for instruction: %V32i1 = call i1 @llvm.vector.reduce.umax.v32i1(<32 x i1> undef)
