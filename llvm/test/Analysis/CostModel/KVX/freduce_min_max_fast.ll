...
; CV1-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %2 = tail call fast float @llvm.vector.reduce.fmax.v2f32(<2 x float> %0)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret float %2
;
; CV2-LABEL: 'red_max_float2'
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %2 = tail call fast float @llvm.vector.reduce.fmax.v2f32(<2 x float> %0)
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 14 for instruction: %2 = tail call fast float @llvm.vector.reduce.fmax.v4f32(<4 x float> %0)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret float %2
;
; CV2-LABEL: 'red_max_float4'
; CV2-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %2 = tail call fast float @llvm.vector.reduce.fmax.v4f32(<4 x float> %0)
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret float %2
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 26 for instruction: %2 = tail call fast float @llvm.vector.reduce.fmax.v8f32(<8 x float> %0)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret float %2
;
; CV2-LABEL: 'red_max_float8'
; CV2-NEXT:  Cost Model: Found an estimated cost of 5 for instruction: %2 = tail call fast float @llvm.vector.reduce.fmax.v8f32(<8 x float> %0)
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret float %2
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 46 for instruction: %3 = tail call fast float @llvm.vector.reduce.fmax.v16f32(<16 x float> %2)
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %3 = tail call fast float @llvm.vector.reduce.fmax.v16f32(<16 x float> %2)
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %2 = tail call fast double @llvm.vector.reduce.fmax.v2f64(<2 x double> %0)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret double %2
;
; CV2-LABEL: 'red_max_double2'
; CV2-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %2 = tail call fast double @llvm.vector.reduce.fmax.v2f64(<2 x double> %0)
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %2 = tail call fast double @llvm.vector.reduce.fmax.v4f64(<4 x double> %0)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret double %2
;
; CV2-LABEL: 'red_max_double4'
; CV2-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %2 = tail call fast double @llvm.vector.reduce.fmax.v4f64(<4 x double> %0)
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret double %2
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %3 = tail call fast double @llvm.vector.reduce.fmax.v8f64(<8 x double> %2)
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %3 = tail call fast double @llvm.vector.reduce.fmax.v8f64(<8 x double> %2)
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %2 = tail call fast half @llvm.vector.reduce.fmax.v2f16(<2 x half> %0)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret half %2
;
; CV2-LABEL: 'red_max_half2'
; CV2-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %2 = tail call fast half @llvm.vector.reduce.fmax.v2f16(<2 x half> %0)
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %2 = tail call fast half @llvm.vector.reduce.fmax.v4f16(<4 x half> %0)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret half %2
;
; CV2-LABEL: 'red_max_half4'
; CV2-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %2 = tail call fast half @llvm.vector.reduce.fmax.v4f16(<4 x half> %0)
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret half %2
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 24 for instruction: %2 = tail call fast half @llvm.vector.reduce.fmax.v8f16(<8 x half> %0)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret half %2
;
; CV2-LABEL: 'red_max_half8'
; CV2-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %2 = tail call fast half @llvm.vector.reduce.fmax.v8f16(<8 x half> %0)
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret half %2
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 44 for instruction: %2 = tail call fast half @llvm.vector.reduce.fmax.v16f16(<16 x half> %0)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret half %2
;
; CV2-LABEL: 'red_max_half16'
; CV2-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %2 = tail call fast half @llvm.vector.reduce.fmax.v16f16(<16 x half> %0)
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret half %2
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %2 = tail call fast float @llvm.vector.reduce.fmin.v2f32(<2 x float> %0)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret float %2
;
; CV2-LABEL: 'red_min_float2'
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %2 = tail call fast float @llvm.vector.reduce.fmin.v2f32(<2 x float> %0)
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret float %2
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 14 for instruction: %2 = tail call fast float @llvm.vector.reduce.fmin.v4f32(<4 x float> %0)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret float %2
;
; CV2-LABEL: 'red_min_float4'
; CV2-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %2 = tail call fast float @llvm.vector.reduce.fmin.v4f32(<4 x float> %0)
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret float %2
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 26 for instruction: %2 = tail call fast float @llvm.vector.reduce.fmin.v8f32(<8 x float> %0)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret float %2
;
; CV2-LABEL: 'red_min_float8'
; CV2-NEXT:  Cost Model: Found an estimated cost of 5 for instruction: %2 = tail call fast float @llvm.vector.reduce.fmin.v8f32(<8 x float> %0)
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret float %2
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %2 = load <16 x float>, ptr %0, align 32
; CV1-NEXT:  Cost Model: Found an estimated cost of 46 for instruction: %3 = tail call fast float @llvm.vector.reduce.fmin.v16f32(<16 x float> %2)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret float %3
;
; CV2-LABEL: 'red_min_float16'
; CV2-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %2 = load <16 x float>, ptr %0, align 32
; CV2-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %3 = tail call fast float @llvm.vector.reduce.fmin.v16f32(<16 x float> %2)
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret float %3
;
  %2 = load <16 x float>, ptr %0
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %2 = tail call fast double @llvm.vector.reduce.fmin.v2f64(<2 x double> %0)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret double %2
;
; CV2-LABEL: 'red_min_double2'
; CV2-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %2 = tail call fast double @llvm.vector.reduce.fmin.v2f64(<2 x double> %0)
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret double %2
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %2 = tail call fast double @llvm.vector.reduce.fmin.v4f64(<4 x double> %0)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret double %2
;
; CV2-LABEL: 'red_min_double4'
; CV2-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %2 = tail call fast double @llvm.vector.reduce.fmin.v4f64(<4 x double> %0)
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret double %2
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %2 = load <8 x double>, ptr %0, align 32
; CV1-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %3 = tail call fast double @llvm.vector.reduce.fmin.v8f64(<8 x double> %2)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret double %3
;
; CV2-LABEL: 'red_min_double8'
; CV2-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %2 = load <8 x double>, ptr %0, align 32
; CV2-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %3 = tail call fast double @llvm.vector.reduce.fmin.v8f64(<8 x double> %2)
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret double %3
;
  %2 = load <8 x double>, ptr %0
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %2 = tail call fast half @llvm.vector.reduce.fmin.v2f16(<2 x half> %0)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret half %2
;
; CV2-LABEL: 'red_min_half2'
; CV2-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %2 = tail call fast half @llvm.vector.reduce.fmin.v2f16(<2 x half> %0)
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret half %2
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %2 = tail call fast half @llvm.vector.reduce.fmin.v4f16(<4 x half> %0)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret half %2
;
; CV2-LABEL: 'red_min_half4'
; CV2-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %2 = tail call fast half @llvm.vector.reduce.fmin.v4f16(<4 x half> %0)
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret half %2
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 24 for instruction: %2 = tail call fast half @llvm.vector.reduce.fmin.v8f16(<8 x half> %0)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret half %2
;
; CV2-LABEL: 'red_min_half8'
; CV2-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %2 = tail call fast half @llvm.vector.reduce.fmin.v8f16(<8 x half> %0)
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret half %2
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 44 for instruction: %2 = tail call fast half @llvm.vector.reduce.fmin.v16f16(<16 x half> %0)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret half %2
;
; CV2-LABEL: 'red_min_half16'
; CV2-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %2 = tail call fast half @llvm.vector.reduce.fmin.v16f16(<16 x half> %0)
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret half %2
;
