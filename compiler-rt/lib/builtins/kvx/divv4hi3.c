//===-- divv4hi3.c - Implement __divv4hi3 ------------------------------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file implements __divv4hi3 for the kvx compiler_rt library.
//
//===----------------------------------------------------------------------===//
...
#include "vecMacros.h"
v4i16 __divv4hi3(v4i16 a, v4i16 b) {
  ...
  return __builtin_kvx_selecthq(-q, q, a ^ b, ".ltz");
}
