...
// XFAIL: target={{(aarch64|arm64).*}}, target=x86_64-pc-windows-msvc, target=x86_64-{{(pc|w64)}}-windows-gnu, target=kvx-{{.*}}

// PR1513

// AArch64, KVX ABI actually requires the reverse of what this is testing: the callee
